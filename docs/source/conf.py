# -*- coding: utf-8 -*-
#
# PyRecord documentation build configuration file, created by
...
project = u'PyRecord'
copyright = u'2013-2014, Gustavo Narea'
...
latex_documents = [
  ('index', 'PyRecord.tex', u'PyRecord Documentation',
...
man_pages = [
    ('index', 'pyrecord', u'PyRecord Documentation',
     [u'Gustavo Narea'], 1)
]
...
texinfo_documents = [
  ('index', 'PyRecord', u'PyRecord Documentation',
   u'Gustavo Narea', 'PyRecord', 'One line description of project.',
   'Miscellaneous'),
]
